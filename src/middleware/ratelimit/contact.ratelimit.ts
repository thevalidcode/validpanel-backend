...
export const limitContactMessageCreate = rateLimit({
...
export const limitContactMessageView = rateLimit({
...
export const limitContactMessageUpdate = rateLimit({
...
export const limitContactMessageDelete = rateLimit({
