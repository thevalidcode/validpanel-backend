...
export const limitLogin = devBypass(
  rateLimit({
...
export const limitPasswordReset = devBypass(
  rateLimit({
...
export const limitForgotPassword = devBypass(
  rateLimit({
    windowMs: 60 * 60 * 1000, // 1 hour
    max: 3, // 3 attempts per hour
...
export const limitSessionVerify = devBypass(
  rateLimit({
