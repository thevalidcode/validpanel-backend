...
export const limitSubscriptionCreate = rateLimit({
...
export const limitPlanUpgrade = rateLimit({
  windowMs: 30 * 60 * 1000, // 30 minutes
...
export const limitPlanDowngrade = rateLimit({
  windowMs: 30 * 60 * 1000, // 30 minutes
...
export const limitSubscriptionRenew = rateLimit({
...
export const limitSubscriptionView = rateLimit({
...
export const limitSubscriptionUpdate = rateLimit({
