...
export const limitPaymentGatewayCreate = devBypass(
  rateLimit({
...
export const limitPaymentGatewayUpdate = devBypass(
  rateLimit({
...
export const limitPaymentGatewayDelete = devBypass(
  rateLimit({
  windowMs: 30 * 60 * 1000, // 30 minutes
...
export const limitPaymentGatewayView = devBypass(
  rateLimit({
